...
import com.github.talrey.createdeco.registrate.fn.NonNullBiFunction;
...
public class BlockBuilder<T extends Block, P> extends AbstractBuilder<T, P, BlockBuilder<T, P>> {
    ...
    public BlockBuilder(CreateRegistrate owner, P parent, String name, NonNullFunction<BlockBehaviour.Properties, T> factory) {
    ...
    public <I extends Item> ItemBuilder<I, BlockBuilder<T, P>> item(NonNullBiFunction<? super T, Item.Properties, I> itemFactory) {
    ...
    public BlockEntry<T> register() {
        ...
        getOwner().trackRegistered(Registries.BLOCK, id);
        if (itemBuilder != null)
